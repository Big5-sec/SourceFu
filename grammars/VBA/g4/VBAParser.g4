...
singleLetter : {_input.LT(1).getText().length() == 1 && Character.isLetter(_input.LT(1).getText().charAt(0))}? IDENTIFIER;
...
universalLetterRange : {_input.LT(1).getText() == "A" && _input.LT(3).getText() == "Z"}? IDENTIFIER MINUS IDENTIFIER;
...
lineSpecialFormOption : {_input.LT(1).getText().toLowerCase() == "b" || _input.LT(1).getText().toLowerCase() == "bf"}? unrestrictedIdentifier;
...
legalLabelIdentifier : { _input.LA(1) != DOEVENTS && _input.LA(1) != END && _input.LA(1) != CLOSE && _input.LA(1) != ELSE && _input.LA(1) != LOOP && _input.LA(1) != NEXT && _input.LA(1) != RANDOMIZE && _input.LA(1) != REM && _input.LA(1) != RESUME && _input.LA(1) != RETURN && _input.LA(1) != STOP && _input.LA(1) != WEND}? identifier | markerKeyword;
...
lExpression :
    standardFunctionKeyword LPAREN whiteSpace? argumentList? whiteSpace? RPAREN                                     # standardExpr
