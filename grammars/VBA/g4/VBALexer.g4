...
SPLIT : S P L I T;
STR: S T R;
STRCOMP: S T R C O M P;
STRCONV: S T R C O N V;
STRREVERSE: S T R R E V E R S E;
TRIM: T R I M;
UCASE: U C A S E;
VAL: V A L;
/*DATE: D A T E;*/
...
DATESERIAL: D A T E S E R I A L;
DATEVALUE1: D A T E V A L U E;
DAY: D A Y;
HOUR: H O U R;
MINUTE: M I N U T E;
MONTH:M O N T H;
MONTHNAME1: M O N T H N A M E;
NOW: N O W;
TIMESERIAL: T I M E S E R I A L;
TIMEVALUE1: T I M E V A L U E;
WEEKDAY: W E E K D A Y;
WEEKDAYNAME: W E E K D A Y N A M E;
YEAR: Y E A R;
ABS: A B S;
ATN: A T N;
COS: C O S;
...
SQR: S Q R;
TAN: T A N;
ENVIRON: E N V I R O N;
ISDATE: I S D A T E;
ISEMPTY: I S E M P T Y;
ISERROR: I S E R R O R;
ISNULL: I S N U L L;
...
CURDIR: C U R D I R;
DIR: D I R;
FILEDATETIME: F I L E D A T E T I M E;
FILELEN: F I L E L E N;
GETATTR: G E T A T T R;
MKDIR: M K D I R;
...
CSTR: C S T R;
CVAR: C V A R;*/
CREATEOBJECT: C R E A T E O B J E C T;
/*MSGBOX: M S G B O X;*/
ASCW: A S C W;
ROUNDUP: R O U N D U P;
ROUNDDOWN: R O U N D D O W N;
/*OBJECT: O B J E C T;*/
